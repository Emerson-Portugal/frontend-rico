...
@Component({
  selector: 'app-shift-assignments-list',
  standalone: true,
  imports: [CustomTableComponent],
  templateUrl: './shift-assignments-list.component.html',
  styles: ``
})
export class ShiftAssignmentsListComponent {

  private readonly shiftAssignmentsService = inject(ShiftAssignmentsService)

  title = 'Asiganciones de Turno'
  columns: TableColumn<ShiftAssignmentDto>[] = [
    {
      label: 'ID',
      property: 'id',
      type: 'text',
    ...
    {
      label: 'Fecha Inicio Asignada',
      property: 'turno_trabajo.fecha_inicio',
      type: 'text',
      visible: true,
      cssClasses: ['font-medium'],
    },
    {
      label: 'Fecha Fin Asignada',
      property: 'turno_trabajo.fecha_fin',
      type: 'text',
      visible: true,
      cssClasses: ['font-medium'],
    },
